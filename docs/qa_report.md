...
> **发布版本**：v0.2.0  
> **报告生成时间**：2026-08-22 02:31:13  
> **Git 提交**：120b7a7 (chore/daily-fix-review-agent)  
...
| :--- | :--- | :---: | :---: | :---: | :---: | :---: |
| **后端核心单元测试** | `cd backend && npm test` | 36 | 36 | 0 | 965ms | ✅ PASS |
| **前端单元与 E2E 测试** | `cd frontend && npm test` | 5 | 5 | 0 | 4.2s | ✅ PASS |
