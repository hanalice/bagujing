...
> **发布版本**：v0.2.0  
> **报告生成时间**：2026-08-21 22:30:15  
> **Git 提交**：4862f8e (auto-fix/a4-20260821)  
...
| :--- | :--- | :---: | :---: | :---: | :---: | :---: |
| **后端核心单元测试** | `cd backend && npm test` | 36 | 36 | 0 | 815ms | ✅ PASS |
| **前端单元与 E2E 测试** | `cd frontend && npm test` | 5 | 5 | 0 | 8.3s | ✅ PASS |
