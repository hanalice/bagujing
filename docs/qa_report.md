...
> **发布版本**：v0.2.0  
> **报告生成时间**：2026-08-23 22:37:00  
> **Git 提交**：0f1c80f (auto-fix/a5-20260823)  
...
| :--- | :--- | :---: | :---: | :---: | :---: | :---: |
| **后端核心单元测试** | `cd backend && npm test` | 39 | 39 | 0 | 966ms | ✅ PASS |
| **前端单元与 E2E 测试** | `cd frontend && npm test` | 5 | 5 | 0 | 8.5s | ✅ PASS |
