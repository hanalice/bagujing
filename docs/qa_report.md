...
> **发布版本**：v0.2.0  
> **报告生成时间**：2026-08-22 02:57:02  
> **Git 提交**：e9ef99c (chore/windows-daily-fix-task)  
...
| :--- | :--- | :---: | :---: | :---: | :---: | :---: |
| **后端核心单元测试** | `cd backend && npm test` | 36 | 36 | 0 | 1007ms | ✅ PASS |
| **前端单元与 E2E 测试** | `cd frontend && npm test` | 5 | 5 | 0 | 4.1s | ✅ PASS |
